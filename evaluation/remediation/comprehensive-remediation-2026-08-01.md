...
8. **CI ancestry:** Comparative freshness checks require the pinned baseline commit to exist locally. Draft-PR runs exposed default shallow checkouts in both matrix and quality jobs; every validating checkout now fetches complete history and a regression test protects that prerequisite.
